...
const RequestSearchBar: React.FC<Props> = ({ onSearch }) => {
    const [showRequestFiltersModal, setShowRequestFiltersModal] = React.useState<boolean>(false);


    const openRequestFiltersModal = () => {
        setShowRequestFiltersModal(true);
    };

    const closeRequestFiltersModal = () => {
        setShowRequestFiltersModal(false);
    };
